import slider from "../../public/slide1.png"
import slider1 from "../../public/slide2.png"
import slider2 from "../../public/slide3.png"
...
export default function EditorsPicks(){
    return(
      ...
      <h2 className="text-3xl font-extrabold text-center  text-gray-800 mb-6">EDITORS PICK</h2>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6">
        ...
        <div
          ...
          <div className="w-6/6 h-[260px] p-4 overflow-hidden mx-auto aspect-w-35 aspect-h-12">
            <Image src={slider1} alt="slider1"
              className="h-full w-full object-contain" />
          </div>
          <div className="p-6 bg-white">
            <h3 className="text-lg font-bold text-gray-800">Men</h3>
            <h4 className="text-lg text-gray-800 font-bold mt-2">$15.5</h4>
            <p className="text-gray-600 text-sm mt-2">5 types of shoes available</p>
        ...
        <div
          ...
          <div className="w-9/6 h-[260px] p-4 overflow-hidden mx-auto aspect-w-16 aspect-h-8">
           <Image src={slider2} alt="slider2"
              className="h-full w-full object-contain" />
          </div>
          <div className="p-6 bg-white">
            <h3 className="text-lg font-bold text-gray-800">Women</h3>
            <h4 className="text-lg text-gray-800 font-bold mt-2">$14.5</h4>
            <p className="text-gray-600 text-sm mt-2">5 types of Women available</p>
        ...
        <div
          ...
          <div className="p-6 bg-white">
            <h3 className="text-lg font-bold text-gray-800">Kids </h3>
            <h4 className="text-lg text-gray-800 font-bold mt-2">$14.5</h4>
            <p className="text-gray-600 text-sm mt-2">5 types of Kids available</p>
        ...
        <div
          ...
          <div className="p-6 bg-white">
            <h3 className="text-lg font-bold text-gray-800">Best Seller</h3>
            <h4 className="text-lg text-gray-800 font-bold mt-2">$14.5</h4>
            <p className="text-gray-600 text-sm mt-2">5 types of best Seller available</p>
