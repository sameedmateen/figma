export default function Contact(){
    return(
        <>
        <h1>C<div className="max-w-5xl max-lg:max-w-3xl mx-auto bg-white my-6 font-[sans-serif]">
                            ...
                            <div className="col-span-full">
                                ...
                                <div className="flex max-lg:flex-col gap-6 mt-4">
                                    ...
                                    <div className="flex items-center">
                                        ...
                                        <p className="text-sm text-gray-500 ml-4">Complain</p>
                                    </div>
                                    ...
                                    <div className="flex items-center">
                                        ...
                                        <p className="text-sm text-gray-500 ml-4">Product Feedback</p>
                                    </div>
                                </div>
                            </div>
                        </div>
