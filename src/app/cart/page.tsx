import slider1 from "../../../public2/slide1.png"
import slider2 from "../../../public2/slide2.png"
import slider3 from "../../../public2/slide3.png"
                    ...
                    <div className="space-y-4">
                        <div className="grid grid-cols-3 items-center gap-4">
                            <div className="col-span-2 flex items-center gap-4">
                                ...
                                <div>
                                    <h3 className="text-base font-bold text-gray-800">New Arrival</h3>
                        ...
                        <div className="grid grid-cols-3 items-center gap-4">
                            <div className="col-span-2 flex items-center gap-4">
                                ...
                                <div>
                                    <h3 className="text-base font-bold text-gray-800">Best Seller</h3>
                                    <h6 className="text-xs text-red-500 cursor-pointer mt-0.5">Remove</h6>
                        ...
                        <div className="grid grid-cols-3 items-center gap-4">
                            <div className="col-span-2 flex items-center gap-4">
                                ...
                                <div>
                                    <h3 className="text-base font-bold text-gray-800">Kids Shoes</h3>
                                    <h6 className="text-xs text-red-500 cursor-pointer mt-0.5">Remove</h6>
